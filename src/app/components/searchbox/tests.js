...
describe('searchbox component', () => {
  ...
  describe('component', () => {
    ...
    it('renders with a default state', () => {
      ...
      expect(searchbox.is('div.searchbox')).to.be.true
      expect(searchbox.children().length).to.equal(2)

      const searchboxSearchIconWrapper = searchbox.childAt(0)
      expect(searchboxSearchIconWrapper.is('div.searchbox-icon')).to.be.true
      ...
      expect(searchboxInputWrapper.is('div.searchbox-input')).to.be.true
    ...
    it('renders with a remove icon', () => {
      ...
      expect(searchboxRemoveIconWrapper.is('div.searchbox-icon')).to.be.true
